...
def accept_result():
    ...
    if not letter_range:
        print("Invalid: Missing letter range")
    ...
    return {"error": "Validation has failed"}, 400
...
def run_acceptor():
    ...
    print("Acceptor is running on port 5003")

    def send_test_request():
        time.sleep(1)
        sidecar.send("http://127.0.0.1:5020/register",
                     {"type": "acceptor", "url": "http://127.0.0.1:5003"},
                     retries=3, delay=1)
